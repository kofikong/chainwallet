...
import com.chaindemo.demo.constant.SecretConstant;
import com.chaindemo.demo.secret.AESSecretUtil;
...
//        return retMap!=null?JSONObject.toJSONString(retMap):null;
        return retMap!=null?JSONObject.fromObject(retMap).toString():null;
    }
}
